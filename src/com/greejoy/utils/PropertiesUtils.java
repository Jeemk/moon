...
public class PropertiesUtils {
	...
	public static String default_config ="properties/sc/config_hive.properties";//默认属性文件名称
	...
	public static void startConfig(){
		String struts_cl = PropertiesUtils.class.getResource("/").getPath();
		//System.out.println(default_config+"------------");
		 ...
		 try{
			 ...
			 File file = ResourceUtils.getFile(struts_cl + default_config);//linux
